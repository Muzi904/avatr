...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            ...
            <form action="{{ route('admin.users.update') }}" class="formgroup" id="obj-form"
                            ...
                            {{-- <div class="form-group row" style="padding-top: 10px;">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('display_name') is-invalid @enderror"
                                        name="display_name" value="{{ $user->display_name }}" placeholder="Display Name">
                                    @error('display_name')
                                        <span class="invalid feedback text-danger"role="alert">
                                            <strong>{{ $message }}.</strong>
                                        </span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('job_title') is-invalid @enderror"
                                        name="job_title" placeholder="Job title" value="{{ $user->jobtitle }}">
                                    @error('job_title')
                                        <span class="invalid feedback text-danger"role="alert">
                                            <strong>{{ $message }}.</strong>
                                        </span>
                            ...
                            <div class="form-group row" style="padding-top: 10px;">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('email') is-invalid @enderror"
                                        name="email" placeholder="Primary Email" value="{{ $user->email }}">
                                    @error('email')
                                        <span class="invalid feedback text-danger"role="alert">
                                            <strong>{{ $message }}.</strong>
                                        </span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-select multiple  @error('roles') is-invalid @enderror"
                                        ...
                                        @foreach ($roles as $key => $role)
                                            <option value="{{ $key }}"
                                                {{ in_array($key, $userRole) ? 'selected' : '' }}>{{ $role }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('roles')
                            ...
                            <div class="form-group row" style="padding-top: 10px;">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('mobile') is-invalid @enderror"
                                        name="mobile" value="{{ $user->mobile }}" placeholder="e.g. 971 123 45678">
                                    @error('mobile')
                                        <span class="invalid feedback text-danger"role="alert">
                                            <strong>{{ $message }}.</strong>
                                        </span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('office_phone') is-invalid @enderror"
                                        name="office_phone"value="{{ $user->office_phone }}"
                            ...
                            {{-- <div class="form-group row" style="padding-top: 10px;">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('email_1') is-invalid @enderror"
                                        name="email_1"value="{{ $user->email1 }}" placeholder="Secondary Email">
                                    @error('email_1')
                                        <span class="invalid feedback text-danger"role="alert">
                                            <strong>{{ $message }}.</strong>
                                        </span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('mobile_1') is-invalid @enderror"
                                        name="mobile_1"value="{{ $user->mobile1 }}" placeholder="e.g. 971 123 45678">
                                    @error('mobile_1')
                                        <span class="invalid feedback text-danger"role="alert">
                                            <strong>{{ $message }}.</strong>
                                        </span>
