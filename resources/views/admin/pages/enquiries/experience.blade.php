...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <!-- Responsive Table -->
        <div class="card p-5">
            <h3 class="card-title">EXPERIENCE REQUESTS</h3>
            ...
            <div class="table-responsive text-nowrap">
                <table class="table datatable experience-table w-100">
                    <thead>
    ...
    <form action="{{ route('admin.enquiry.export') }}" method="post" id="export-form">
        ...
        <input type="hidden" name="type" id="type_export" value="experience">
    </form>
@endsection
@push('scripts')
    @include('admin.scripts.experience_js')
@endpush
