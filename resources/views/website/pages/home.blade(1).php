...
driving experience. </p>
    ...
    <div class="swiper-container swiper car-models animate-text">
        <div class="swiper-wrapper" id="slider-wrapper">
            ...
            <div class="swiper-slide" id="red-slide">
                <img class="w-100 my-50" src="{{ asset('website/images/home/color-variants/avartr11/img1.jpg') }}" alt="Red Car">
            </div>
            <!-- Blue image -->
            <div class="swiper-slide" id="blue-slide" style="display: none;">
                <img class="w-100 my-50" src="{{ asset('website/images/home/color-variants/avartr11/img2.jpg') }}" alt="Blue Car">
            </div>
            <!-- Green image -->
            <div class="swiper-slide" id="green-slide" style="display: none;">
                <img class="w-100 my-50" src="{{ asset('website/images/home/color-variants/avartr11/img3.jpg') }}" alt="Green Car">
            </div>
            <!-- Black image -->
            <div class="swiper-slide" id="black-slide" style="display: none;">
                <img class="w-100 my-50" src="{{ asset('website/images/home/color-variants/avartr11/img4.jpg') }}" alt="Black Car">
            </div>
            <!-- White image -->
            <div class="swiper-slide" id="white-slide" style="display: none;">
                <img class="w-100 my-50" src="{{ asset('website/images/home/color-variants/avartr11/img5.jpg') }}" alt="White Car">
            </div>
            <!-- Yellow image -->
            <div class="swiper-slide" id="yellow-slide" style="display: none;">
                <img class="w-100 my-50" src="{{ asset('website/images/home/color-variants/avartr11/img6.jpg') }}" alt="Yellow Car">
            </div>
        </div>
    ...
    <div class="d-flex align-items-center gap-3 mt-3 justify-content-center">
        <button class="varient-btn active" data-color="red">
            <img src="{{ asset('website/images/home/color-variants/avartr11/color-img1.png') }}" alt="Red">
        </button>
        <!-- Button for Blue -->
        <button class="varient-btn" data-color="blue">
            <img src="{{ asset('website/images/home/color-variants/avartr11/color-img2.png') }}" alt="Blue">
        </button>
        <!-- Button for Green -->
        <button class="varient-btn" data-color="green">
            <img src="{{ asset('website/images/home/color-variants/avartr11/color-img3.png') }}" alt="Green">
        </button>
        <!-- Button for Black -->
        <button class="varient-btn" data-color="black">
            <img src="{{ asset('website/images/home/color-variants/avartr11/color-img4.png') }}" alt="Black">
        </button>
        <!-- Button for White -->
        <button class="varient-btn" data-color="white">
            <img src="{{ asset('website/images/home/color-variants/avartr11/color-img5.png') }}" alt="White">
        </button>
        <!-- Button for Yellow -->
        <button class="varient-btn" data-color="yellow">
            <img src="{{ asset('website/images/home/color-variants/avartr11/color-img6.png') }}" alt="Yellow">
        </button>
    </div>
...
.varient-btn.active {
    border: 2px solid #000; /* Border around active button */
...
.varient-btn.active img {
    transform: scale(1.1); /* Slightly increase image size when active */
}
    ...
    <div class="swiper-container swiper car-models animate-text">
        <div class="swiper-wrapper" id="slider-wrapper-2">
            ...
            <div class="swiper-slide" id="red-slide-2">
                <img class="w-100 my-50" src="{{ asset('website/images/home/color-variants/avatr12/img1.jpg') }}" alt="Red Car">
            </div>
            <!-- Blue image -->
            <div class="swiper-slide" id="blue-slide-2" style="display: none;">
                <img class="w-100 my-50" src="{{ asset('website/images/home/color-variants/avatr12/img2.jpg') }}" alt="Blue Car">
            </div>
            <!-- Green image -->
            <div class="swiper-slide" id="green-slide-2" style="display: none;">
                <img class="w-100 my-50" src="{{ asset('website/images/home/color-variants/avatr12/img3.jpg') }}" alt="Green Car">
            </div>
            <!-- Black image -->
            <div class="swiper-slide" id="black-slide-2" style="display: none;">
                <img class="w-100 my-50" src="{{ asset('website/images/home/color-variants/avatr12/img4.jpg') }}" alt="Black Car">
            </div>
            <!-- White image -->
            <div class="swiper-slide" id="white-slide-2" style="display: none;">
                <img class="w-100 my-50" src="{{ asset('website/images/home/color-variants/avatr12/img5.jpg') }}" alt="White Car">
            </div>
            <!-- Yellow image -->
            <div class="swiper-slide" id="yellow-slide-2" style="display: none;">
                <img class="w-100 my-50" src="{{ asset('website/images/home/color-variants/avatr12/img6.jpg') }}" alt="Yellow Car">
            </div>
        </div>
        <div class="swiper-button-prev"></div>
        <div class="swiper-button-next"></div>
    ...
    <div class="d-flex align-items-center gap-3 mt-3 justify-content-center">
        <button class="varient-btn active" data-color="red">
            <img src="{{ asset('website/images/home/color-variants/avatr12/color-img1.png') }}" alt="Red">
        </button>
        <!-- Button for Blue -->
        <button class="varient-btn" data-color="blue">
            <img src="{{ asset('website/images/home/color-variants/avatr12/color-img2.png') }}" alt="Blue">
        </button>
        <!-- Button for Green -->
        <button class="varient-btn" data-color="green">
            <img src="{{ asset('website/images/home/color-variants/avatr12/color-img3.png') }}" alt="Green">
        </button>
        <!-- Button for Black -->
        <button class="varient-btn" data-color="black">
            <img src="{{ asset('website/images/home/color-variants/avatr12/color-img4.png') }}" alt="Black">
        </button>
        <!-- Button for White -->
        <button class="varient-btn" data-color="white">
            <img src="{{ asset('website/images/home/color-variants/avatr12/color-img5.png') }}" alt="White">
        </button>
        <!-- Button for Yellow -->
        <button class="varient-btn" data-color="yellow">
            <img src="{{ asset('website/images/home/color-variants/avatr12/color-img6.png') }}" alt="Yellow">
        </button>
    </div>
